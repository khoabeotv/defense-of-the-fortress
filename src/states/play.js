var playState = {
    create: function() {
        ...
        Dotf.playerHealth = Dotf.game.add.text(50, 20, `Health: ${ Dotf.player.sprite.health }`, {
            font: '24px Arial',
            fill: '#fff'
        });
        Dotf.playerHealth.fixedToCamera = true;
        Dotf.playerCoin = Dotf.game.add.text(200, 20, `Coin: ${ Dotf.player.sprite.coin }`, {
            font: '24px Arial',
            fill: '#fff'
        });
        Dotf.playerCoin.fixedToCamera = true;
        Dotf.baseHealth = Dotf.game.add.text(320, 20, `Base Health: ${ Dotf.base.sprite.heath }`, {
            font: '24px Arial',
            fill: '#fff'
        });
        ...
        // Paused
        Dotf.pauseButton = Dotf.game.add.button(Dotf.game.centerX, Dotf.game.centerY, 'Back', actionOnClick, this);
